...
@click.command()
@click.option("--code", default="sh.601318", help="baostock股票/指数代码，如sh.600000")
@click.option("--start", default="2018-12-01", help="开始日期, 格式如：2010-01-01")
@click.option("--end", default="2022-01-11", help="结束日期, 格式如：2010-01-01")
@click.option("--adj", default="2", help="复权类型(只针对股票)：3: 未复权 2:前复权 1:后复权 , 默认1")
