...
if __name__ == '__main__':
    print("执行中。。。")
    values=forExcel.readExcelSheet("F:\\ahp\\lianghua.xlsx")
    firstval=values[0][0]
    ...
    for mtkey in maptab:
        ...
        updateOracle("tjbk_sh_test/tjbk_sh_test@192.168.85.81:1521/emserver", sqlyuanshi)
    ...
    for coulmnkeys in mapname.keys():
        if biaoshi!="" and biaoshi!=mapname[coulmnkeys][0]["coulmnname"]:
            ...
            updateOracle("tjbk_sh_test/tjbk_sh_test@192.168.85.81:1521/emserver", sqla)
        ...
        for quanzhi in mapname[coulmnkeys]:
            ...
            updateOracle("tjbk_sh_test/tjbk_sh_test@192.168.85.81:1521/emserver", sql)
            inlist = []
            outmap = {}
            ...
            result=usePro("tjbk_sh_test/tjbk_sh_test@192.168.85.81:1521/emserver", calname, inlist, outmap)
