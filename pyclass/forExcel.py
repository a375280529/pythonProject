...
if __name__ == '__main__':
    # 数据集
    dataset = [{"123456":[
        {"姓名": "张三zzzzzzzzzzzzzzzzzzz", "年龄": "zzzzzzzzzz123", "性别": "zzzzzzzzzzzzzzz男"},
        {"姓名": "李四xxxxxxxxxxxxxxxxxxx", "年龄": "xxxxxxxxxxxx234", "性别": "xxxxxxxxxxxxxxxx男"},
        {"姓名": "王五ccccccccccccccccccc", "年龄": "cccccccccccc345", "性别": "cccccccccccccc女"}
    ]},{"987654321":[
        {"姓名": "陈六qqqqqqqqqqqqqqqqqqq", "年龄": "qqqqqqqqqqqq456", "性别": "qqqqqqqqqqqqq女"},
        {"姓名": "刘七wwwwwwwwwwwwwwwwwww", "年龄": "wwwwwwwwwwww567", "性别": "wwwwwwwwwwwwww男"},
        {"姓名": "赵八eeeeeeeeeeeeeeeeeee", "年龄": "eeeeeeeeeeee678", "性别": "eeeeeeeeeeeeee女"}
    ]}]
    getExcel(dataset)